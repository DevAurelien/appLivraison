...
export default function CardMessage({ className, children, titre, signature }) {
  return (
    ...
    >
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/5 border border-white/70 p-1">
        <Director color1="var(--primary)" className="h-full w-full" />
      </div>
