export default function OeilBarre({
  color1 = "#fff",
  color2 = "#000",
  color3 = "none",
  width = 20,
  ...
  onClick,
  pointerEvents = "auto",
  ariaLabel = "Masquer le mot de passe",
}) {
  return (
    <svg
    ...
    >
      ...
      >
        <path
          d="M4215 4415 c-31 -11 -382 -357 -1771 -1747 -1520 -1521 -1734 -1738
        ...
        <path
          fill={color1}
          d="M2335 3989 c-650 -71 -1334 -463 -1676 -961 -111 -162 -179 -340
        ...
        <path
          fill={color1}
          d="M2425 3349 c-312 -58 -561 -287 -639 -589 -19 -74 -32 -234 -22 -274
