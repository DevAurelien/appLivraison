export default function HistoriqueIcone({
  color1 = "#fff",
  color2 = "#000",
  color3 = "none",
  width = 30,
    ...
    >
      ...
      >
        <g
          ...
          stroke={color3}
        >
          <path d="M2450 4615 c-632 -89 -1172 -439 -1503 -975 -64 -104 -159 -308 -193
...
329 -754 532 -1231 590 -115 14 -384 11 -500 -5z" />
          ...
          <path d="M2560 3105 c0 -471 3 -581 14 -608 8 -18 126 -144 263 -280 l249
